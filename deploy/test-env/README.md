...
A throwaway Dupearr you can click around in, wired to **fake** Plex, Radarr, Radarr 4K and Sonarr
...
`setup.sh` configured Dupearr for you: the Plex server, the three *arr instances, identity path
